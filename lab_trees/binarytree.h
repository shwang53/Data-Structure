...
class BinaryTree
{
    public:
        ...
        bool isOrderedRecurHelper (Node* node, T max, T min) const;
        ...
        void getPathsHelp(const Node* tempRoot, vector<vector<T> > &temp, vector<T> history) const;
